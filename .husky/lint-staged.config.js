module.exports = {
  ...
  "services/cms/**/*.{js,jsx,ts,tsx}": () => "npx tsc -p services/cms/ --noEmit",
  "services/main-frontend/**/*.{js,jsx,ts,tsx}": () =>
    "npx tsc -p services/main-frontend/ --noEmit",
  "services/course-material/**/*.{js,jsx,ts,tsx}": () =>
    "npx tsc -p services/course-material/ --noEmit",
  "system-tests/src/**/*.{js,jsx,ts,tsx}": () => "./bin/check-for-test-only",
  ...
  "**/models/**/*.rs": () => ["./services/headless-lms/bin/sqlx-prepare-check"],
}
