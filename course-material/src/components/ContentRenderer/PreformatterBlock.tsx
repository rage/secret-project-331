...
const gradientColorMapper = [
  ...
  ["luminous-vivid-amber-to-luminous-vivid-orange", "linear-gradient(135deg, #fcb900 0%, #ff6900 100%)"],
  ...
  ["cool-to-warm-spectrum", "linear-gradient(135deg, #4aeadc 0%, #9778d1 20%, #cf2aba 40%, #ee2c82 60%, #fb6962 80%, #fef84c 100%)"],
...
background: ${props => props.attributes.gradient !== undefined ? chooseColor([props.attributes.gradient, "gradient"]) : chooseColor([props.attributes.backgroundColor, "solid"])};
