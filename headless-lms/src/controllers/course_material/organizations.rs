...
/**
GET `/api/v0/course-material/organizations` - Returns a list of all organizations.
...
/**
GET `/api/v0/course-material/organizations/{organization_id}/courses"` - Returns a list of all courses in a organization.
