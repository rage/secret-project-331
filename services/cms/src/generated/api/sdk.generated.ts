...
import {
  zDeleteCmsCoursePartnersBlockResponse,
  zDeleteCmsEmailTemplateResponse,
  zGetAllChaptersByCourseIdResponse,
  zGetCmsCodeGiveawaysByCourseResponse,
  zGetCmsCourseDefaultPeerReviewResponse,
  zGetCmsCourseInstanceOrganizationIdResponse,
  zGetCmsCourseInstanceResponse,
  zGetCmsCourseInstancesResponse,
  zGetCmsCourseModulesResponse,
  zGetCmsCourseNondefaultChatbotConfigurationsResponse,
  zGetCmsCoursePagesResponse,
  zGetCmsCoursePartnersBlockResponse,
  zGetCmsCourseResearchFormResponse,
  zGetCmsCourseResponse,
  zGetCmsEmailTemplateResponse,
  zGetCmsExamInstructionsResponse,
  zGetCmsExerciseServicesResponse,
  zGetCmsPageInfoResponse,
...
export const getCmsCourseInstanceOrganizationId = <ThrowOnError extends boolean = true>(
  ...
  >({
    responseValidator: async (data) =>
      await zGetCmsCourseInstanceOrganizationIdResponse.parseAsync(data),
    responseStyle: "data",
...
export const getCmsCourseDefaultPeerReview = <ThrowOnError extends boolean = true>(
  ...
  >({
    responseValidator: async (data) =>
      await zGetCmsCourseDefaultPeerReviewResponse.parseAsync(data),
    responseStyle: "data",
...
export const updateCmsCourseDefaultPeerReview = <ThrowOnError extends boolean = true>(
  ...
  >({
    responseValidator: async (data) =>
      await zUpdateCmsCourseDefaultPeerReviewResponse.parseAsync(data),
    responseStyle: "data",
    url: "/api/v0/cms/courses/{course_id}/default-peer-review",
    ...options,
    headers: {
...
export const getCmsCourseNondefaultChatbotConfigurations = <ThrowOnError extends boolean = true>(
  ...
  >({
    responseValidator: async (data) =>
      await zGetCmsCourseNondefaultChatbotConfigurationsResponse.parseAsync(data),
    responseStyle: "data",
...
export const upsertCmsCourseResearchFormQuestions = <ThrowOnError extends boolean = true>(
  ...
  >({
    responseValidator: async (data) =>
      await zUpsertCmsCourseResearchFormQuestionsResponse.parseAsync(data),
    responseStyle: "data",
...
export const getCmsRepositoryExercisesForCourse = <ThrowOnError extends boolean = true>(
  ...
  >({
    responseValidator: async (data) =>
      await zGetCmsRepositoryExercisesForCourseResponse.parseAsync(data),
    responseStyle: "data",
