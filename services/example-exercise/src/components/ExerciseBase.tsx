  ...
  return (
    ...
    >
      {alternatives.map((option) => {
        ...
        return (
          <button
            // oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- styled <button> intentionally has role=checkbox; an <input type=checkbox> would change behavior/styling
            role="checkbox"
            className={
              interactable
                ? css`
