...
ALTER TABLE feedback DROP exam_id,
  ALTER course_id
SET NOT NULL;
ALTER TABLE gradings DROP exam_id,
  ALTER course_id
SET NOT NULL;
ALTER TABLE submissions DROP exam_id,
  ALTER course_instance_id
SET NOT NULL,
  ALTER course_id
SET NOT NULL;
ALTER TABLE user_exercise_states DROP exam_id,
  ALTER course_instance_id
SET NOT NULL,
  DROP id,
  ADD CONSTRAINT user_exercise_states_pkey PRIMARY KEY (user_id, exercise_id, course_instance_id);
ALTER TABLE exercises DROP exam_id,
  ALTER course_id
SET NOT NULL;
