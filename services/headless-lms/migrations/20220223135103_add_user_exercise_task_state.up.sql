-- Create user exercise task states
CREATE TABLE user_exercise_task_states (
  ...
  PRIMARY KEY (user_exercise_state_id, exercise_task_id)
);
CREATE TRIGGER set_timestamp BEFORE
UPDATE ON user_exercise_task_states FOR EACH ROW EXECUTE PROCEDURE trigger_set_timestamp();
COMMENT ON TABLE user_exercise_task_states IS 'A list of terms and their explanations.';
