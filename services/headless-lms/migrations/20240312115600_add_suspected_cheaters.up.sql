...
COMMENT ON COLUMN course_student_average.student_average_duration IS 'The average total duration other student spent completing the course.';
COMMENT ON COLUMN course_student_average.student_average_points IS 'The average total points other students acquired in the course.';
