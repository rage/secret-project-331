...
COMMENT ON COLUMN exercise_student_average.updates_at IS 'Timestamp when the record was updated.';
...
COMMENT ON COLUMN exercise_student_average.student_average_duration IS 'The average duration a other student used in completing an exercise.';
COMMENT ON COLUMN exercise_student_average.student_average_points IS 'The average points other student received from completing an exercise.';
