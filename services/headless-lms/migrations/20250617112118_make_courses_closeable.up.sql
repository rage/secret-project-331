...
ALTER TABLE courses
ADD COLUMN closed_successor_course_id UUID REFERENCES courses(id);
...
COMMENT ON COLUMN courses.closed_successor_course_id IS 'A course where students will be directed to after the course is closed.';
