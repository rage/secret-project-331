CREATE TABLE mailchimp_language_code_mappings (
  ...
  our_language_code VARCHAR(10) NOT NULL,
  mailchimp_language_code VARCHAR(10) NOT NULL,
...
COMMENT ON COLUMN mailchimp_language_code_mappings.our_language_code IS 'The language code used in mooc.';
COMMENT ON COLUMN mailchimp_language_code_mappings.mailchimp_language_code IS 'The language code used in Mailchimp.';
