...
COMMENT ON COLUMN chatbot_conversation_suggested_messages.conversation_message_id IS 'The chatbot conversation message after which this suggested message was generated. This is how we know which suggested messages to disaplay at the current point in time.';

ALTER TABLE chatbot_configurations
ADD suggest_next_messages BOOLEAN NOT NULL DEFAULT FALSE,
  ADD initial_suggested_messages VARCHAR(32376) [3];
...
COMMENT ON COLUMN chatbot_configurations.initial_suggested_messages IS 'Three messsage suggestions to be dispayed at the beginning of the conversation that the teacher configures.';
