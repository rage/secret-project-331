...
COMMENT ON COLUMN chatbot_configurations.initial_suggested_messages IS 'Unlimited messsage suggestions to be dispayed at the beginning of the conversation that the teacher configures. If more than three, 3 are chosen at random.';
