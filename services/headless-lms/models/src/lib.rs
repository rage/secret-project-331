...
pub mod cheating_confirmation_grade_snapshots;
pub mod cms_ai;
pub mod code_giveaway_codes;
pub mod code_giveaways;
pub mod completion_registration_credit_justifications;
...
pub mod course_module_suotar_configurations;
pub mod course_modules;
pub mod course_page_markdown_content;
...
pub mod credit_registration_enrolment_check_outcomes;
pub mod credit_registration_enrolment_check_signals;
...
pub mod errors;
pub mod exams;
pub mod exercise_answer_uploads;
...
pub mod page_history_spec_files;
...
pub mod user_ai_usage_notice_acknowledgements;
