...
pub async fn get_progress(conn: &mut PgConnection, course_id: Uuid) -> ModelResult<ProgressOverview>{
  ...
  let user_exercise_states = crate::user_exercise_states::get_all_for_course(conn, course_id).await?;
