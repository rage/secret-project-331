...
impl OAuthClient {
    ...
    pub async fn find_by_client_id(conn: &mut PgConnection, client_id: &str) -> ModelResult<Self> {
        let client = sqlx::query_as!(
            ...
            SELECT
              ...
              client_id,
              client_name,
              application_type                as "application_type: ApplicationType",
              ...
              allowed_grant_types             as "allowed_grant_types: GrantType[]",
              scopes,
              require_pkce,
              pkce_methods_allowed            as "pkce_methods_allowed: PkceMethod[]",
              origin,
              bearer_allowed,
              created_at,
              updated_at,
    ...
    pub async fn insert(conn: &mut PgConnection, p: NewClientParams<'_>) -> ModelResult<Self> {
        ...
        let row = sqlx::query_as!(
            ...
            p.client_secret.map(|d| d.as_bytes()),
