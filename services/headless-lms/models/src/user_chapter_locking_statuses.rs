...
async fn get_or_init_status_row(
    ...
    let res = sqlx::query_as!(
        ...
        r#"
SELECT id, created_at, updated_at, deleted_at, user_id, chapter_id, course_id, status
...
RETURNING id, created_at, updated_at, deleted_at, user_id, chapter_id, course_id, status
        "#,
        user_id,
        chapter_id,
        course_id
