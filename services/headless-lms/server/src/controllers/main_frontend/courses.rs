...
```
*/
#[cfg_attr(doc, doc = generated_docs!(CourseStructure))]
...
*/
#[cfg_attr(doc, doc = generated_docs!(Vec<Exercise>))]
#[instrument(skip(pool))]
...
*/
#[cfg_attr(doc, doc = generated_docs!(Vec<SubmissionCount>))]
#[instrument(skip(pool))]
...
*/
#[cfg_attr(doc, doc = generated_docs!(Vec<SubmissionCountByWeekAndHour>))]
#[instrument(skip(pool))]
...
*/
#[cfg_attr(doc, doc = generated_docs!(Vec<SubmissionCountByExercise>))]
#[instrument(skip(pool))]
...
*/
#[cfg_attr(doc, doc = generated_docs!(Vec<Feedback>))]
#[instrument(skip(pool))]
...
*/
#[cfg_attr(doc, doc = generated_docs!(FeedbackCount))]
#[instrument(skip(pool))]
