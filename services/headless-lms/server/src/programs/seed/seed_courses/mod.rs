...
pub async fn seed_sample_course(
    ...
    let (_page, _) = pages::insert_course_page(&mut conn, &welcome_page, teacher_user_id).await?;
    ...
    let (_page, _) = pages::insert_course_page(&mut conn, &hidden_page, teacher_user_id).await?;
...
pub async fn seed_accessibility_course(
    ...
    let new_course = NewCourse {
        ...
        teacher_in_charge_name: "admin".to_string(),
        teacher_in_charge_email: "admin@example.com".to_string(),
        description: "Course for testing accessibility features.".to_string(),
        is_draft: false,
        is_test_mode: false,
        is_unlisted: false,
        copy_user_permissions: false,
    ...
    let (chapter_1, _front_page_1) = library::content_management::create_new_chapter(
        &mut conn,
        PKeyPolicy::Fixed((
            Uuid::new_v5(&course_id, b"a1b2c3d4-e5f6-7890-abcd-ef1234567890"),
            Uuid::new_v5(&course_id, b"b2c3d4e5-f6a7-8901-bcde-f12345678901"),
        )),
        &new_chapter,
        teacher_user_id,
        &spec_fetcher,
    ...
    let (quizzes_exercise_block, quizzes_exercise, quizzes_exercise_slide, quizzes_exercise_task) =
        quizzes_exercise(
            "Choose N exercise".to_string(),
            Uuid::new_v5(&course_id, b"c3d4e5f6-a7b8-9012-cdef-123456789012"),
            false,
            serde_json::json!({
              "version": "2",
            ...
            None,
            CommonExerciseData {
                exercise_id: Uuid::new_v5(&course_id, b"b8c9d0e1-f2a3-4567-6789-678901234567"),
                exercise_slide_id: Uuid::new_v5(
                    &course_id,
                    b"c9d0e1f2-a3b4-5678-7890-789012345678",
                ),
                exercise_task_id: Uuid::new_v5(&course_id, b"d0e1f2a3-b4c5-6789-8901-890123456789"),
                block_id: Uuid::new_v5(&course_id, b"e1f2a3b4-c5d6-7890-9012-901234567890"),
            },
        );
    ...
    create_page(
        ...
        Some(chapter_1.id),
        CmsPageUpdate {
            url_path: "/chapter-1/choose-n-exercise".to_string(),
            title: "Choose N Exercise".to_string(),
            chapter_id: Some(chapter_1.id),
            exercises: vec![quizzes_exercise],
            exercise_slides: vec![quizzes_exercise_slide],
            exercise_tasks: vec![quizzes_exercise_task],
            content: vec![quizzes_exercise_block],
        },
    )
    .await?;
