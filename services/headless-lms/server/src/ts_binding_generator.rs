...
fn models(target: &mut File) {
    ...
    export! {
        ...
        course_designer_plans::CourseDesignerCourseSize,
        course_designer_plans::CourseDesignerPlan,
        course_designer_plans::CourseDesignerPlanDetails,
        course_designer_plans::CourseDesignerPlanMember,
        course_designer_plans::CourseDesignerPlanStage,
        course_designer_plans::CourseDesignerPlanStageStatus,
        course_designer_plans::CourseDesignerPlanStageTask,
        course_designer_plans::CourseDesignerPlanStageWithTasks,
        course_designer_plans::CourseDesignerPlanStatus,
        course_designer_plans::CourseDesignerPlanSummary,
        course_designer_plans::CourseDesignerScheduleStageInput,
        course_designer_plans::CourseDesignerStage,
        course_designer_analysis_workspace::AnalysisCourseType,
        course_designer_analysis_workspace::AnalysisWorkspaceV1,
        course_designer_analysis_workspace::CourseDesignerStageWorkspace,
...
fn controllers(target: &mut File) {
    ...
    // main_frontend
    {
        ...
        export! {
            ...
            course_designer::CourseDesignerScheduleSuggestionRequest,
            course_designer::CourseDesignerScheduleSuggestionResponse,
            course_designer::CreateCourseDesignerPlanRequest,
            course_designer::CreateCourseDesignerStageTaskRequest,
            course_designer::ExtendStageRequest,
            course_designer::SaveCourseDesignerScheduleRequest,
            course_designer::UpdateCourseDesignerStageTaskRequest,
