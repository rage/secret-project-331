...
NON_EXISTING_DB_URL_PRE="${DATABASE_URL//courses_moocfi_/database_that_should_not_exist_}"
NON_EXISTING_DB_URL="${NON_EXISTING_DB_URL_PRE//headless_lms_/database_that_should_not_exist_}"
