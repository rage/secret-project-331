...
var CompletionPage = function () {
  ...
  var userCompletionInformation = (0, react_query_1.useQuery)({
    ...
    queryFn: function () {
      return (0, course_modules_1.fetchUserCompletionInformation)(courseModuleId)
    },
  })
  if (
  ...
  return (
    <>
      {userCompletionInformation.isError && (
        <ErrorBanner_1.default error={userCompletionInformation.error} variant={"readOnly"} />
      )}
      {userCompletionInformation.isLoading && <Spinner_1.default variant={"medium"} />}
      {userCompletionInformation.isSuccess && (
        <RegisterCompletion_1.default
          data={userCompletionInformation.data}
          registrationFormUrl={"".concat(pathname, "/").concat(REDIRECT)}
        />
      )}
    </>
  )
}
exports.default = (0, withErrorBoundary_1.default)(
  (0, LoginStateContext_1.withSignedIn)(CompletionPage),
)
