        ...
        <QueryResult query={query} emptyFallback={<NoDataMessage />}>
          {(data) => {
            const eChartsData = groupBy(data, (o) => {
              ...
              // oxlint-disable-next-line unicorn/prefer-string-slice -- indexOf may return -1; substring clamps negatives to 0 while slice would count from the end, changing behavior
