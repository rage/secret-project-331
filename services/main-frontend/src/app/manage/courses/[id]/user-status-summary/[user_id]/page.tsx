...
const CourseExerciseStatusList: React.FC = () => {
  ...
  const lockMutation = useToastMutation(
  ...
  const unlockMutation = useToastMutation(
    async (chapterId: string) => {
      setLockActionPendingChapterId(chapterId)
  ...
  return (
    <>
      ...
      <ExerciseListSection
        ...
        onLockChapter={(chapterId) => lockMutation.mutate(chapterId)}
        onUnlockChapter={(chapterId) => unlockMutation.mutate(chapterId)}
