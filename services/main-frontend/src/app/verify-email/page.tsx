...
/** Not `/email-verified`: tmc.mooc.fi redirects there, tokenless, after its own confirmation. */
const VerifyEmailPage: React.FC = () => {
  const { t } = useTranslation()
  usePageTitle(t("title-email-address-verification"))
  const token = useSearchParams().get(TOKEN_QUERY_PARAM)

  // A query, not a mutation: per-token caching stops a strict-mode remount from
  // spending the single-use link twice.
  ...
  return (
    <div data-testid="email-verification-outcome">
      ...
      <div className={actionsCss}>
        ...
        <Link href={userSettingsRoute()} styledAsButton variant="secondary" size="medium">
...
export default withErrorBoundary(VerifyEmailPage)
