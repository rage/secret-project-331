 ...
 */
export const uploadFilesFromExerciseService = <ThrowOnError extends boolean = true>(options: Options<UploadFilesFromExerciseServiceData, ThrowOnError>) => (options.client ?? client).post<UploadFilesFromExerciseServiceResponses, unknown, ThrowOnError, 'data'>({
    ...formDataBodySerializer,
    responseValidator: async (data) => await zUploadFilesFromExerciseServiceResponse.parseAsync(data),
    responseStyle: 'data',
