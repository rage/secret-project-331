...
import { fetchPageByCourseIdAndLanguageGroupId } from "@/services/course-material/backend"
...
const useNewPagePath = (
  ...
  const query = useQuery({
    queryKey: [`courses-${course_id}-pages-by-language-group-id-${page_language_group_id}`],
    queryFn: () => {
