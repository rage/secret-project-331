    ...
    <Layout navVariant="simple">
      <div>
        ...
        >
          <p>
            <b>created_at</b>:{" "}
            {query.data.regrading.created_at
              ? dateToString(query.data.regrading.created_at)
              : "null"}
          </p>
          <p>
            <b>updated_at</b>:{" "}
            {query.data.regrading.updated_at
              ? dateToString(query.data.regrading.updated_at)
              : "null"}
          </p>
          <p>
