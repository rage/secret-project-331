 ...
 */
import type { AudioAttributes, BlockAttributes, ButtonAttributes, ButtonsAttributes, CodeAttributes, ColumnAttributes, ColumnsAttributes, EmbedAttributes, FileAttributes, HeadingAttributes, HtmlAttributes, ImageAttributes, ListAttributes, ListItemAttributes, ParagraphAttributes, PreformattedAttributes, PullquoteAttributes, QuoteAttributes, SeparatorAttributes, SpacerAttributes, TableAttributes, Cells, CellAttributes, VerseAttributes } from "./GutenbergBlockAttributes";
...
export function isButtonsAttributes(obj: unknown): obj is ButtonsAttributes {
    ...
    return (
        ...
        (typeof typedObj["layout"] === "undefined" ||
            (typedObj["layout"] !== null &&
                typeof typedObj["layout"] === "object" ||
                typeof typedObj["layout"] === "function") &&
            Object.entries<any>(typedObj["layout"])
                .every(([key, _value]) => (typeof key === "string"))) &&
        (typeof typedObj["metadata"] === "undefined" ||
            (typedObj["metadata"] !== null &&
                typeof typedObj["metadata"] === "object" ||
...
export function isTableAttributes(obj: unknown): obj is TableAttributes {
    ...
    return (
        ...
        typedObj["head"].every((e: any) =>
            isCells(e) as boolean
        ) &&
...
export function isCells(obj: unknown): obj is Cells {
    ...
    return (
        ...
        (typeof typedObj["cells"] === "undefined" ||
            ...
            typedObj["cells"].every((e: any) =>
                isCellAttributes(e) as boolean
            ))
    )
}
...
export function isCellAttributes(obj: unknown): obj is CellAttributes {
    ...
    return (
        ...
        (typeof typedObj["content"] === "undefined" ||
            typeof typedObj["content"] === "string") &&
        (typeof typedObj["tag"] === "undefined" ||
            typeof typedObj["tag"] === "string") &&
        (typeof typedObj["scope"] === "undefined" ||
            typeof typedObj["scope"] === "string") &&
        (typeof typedObj["align"] === "undefined" ||
            typeof typedObj["align"] === "string") &&
        (typeof typedObj["colspan"] === "undefined" ||
            typeof typedObj["colspan"] === "string") &&
        (typeof typedObj["rowspan"] === "undefined" ||
            typeof typedObj["rowspan"] === "string")
    )
}
