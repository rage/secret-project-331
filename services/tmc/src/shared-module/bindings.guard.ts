...
export function isExerciseTask(obj: any, _argumentName?: string): obj is ExerciseTask {
  return (
    ...
    (obj.deleted_at === null || obj.deleted_at instanceof Date) &&
    (obj.public_spec_file_path === null || typeof obj.public_spec_file_path === "string") &&
    (obj.private_spec_file_path === null || typeof obj.private_spec_file_path === "string") &&
    (obj.model_solution_spec_file_path === null ||
      typeof obj.model_solution_spec_file_path === "string") &&
    (obj.copied_from === null || typeof obj.copied_from === "string") &&
    typeof obj.order_number === "number"
  )
}
