...
export interface ExerciseTask {
  ...
  assignment: unknown
  deleted_at: Date | null
  public_spec_json: unknown | null
  public_spec_file_path: string | null
  private_spec_json: unknown | null
  private_spec_file_path: string | null
  model_solution_spec_json: unknown | null
  model_solution_spec_file_path: string | null
  copied_from: string | null
  order_number: number
}
