    ...
    return (
        ((typedObj !== null &&
            ...
            (typedObj !== null &&
                typeof typedObj === "object" ||
                typeof typedObj === "function") &&
            (typedObj["status"] === "finished" ||
                typedObj["status"] === "crashed") &&
            ...
            (typedObj["data"] === null ||
                ...
                (typedObj["data"]["output-data"]["kind"] === "not-logged-in" ||
                    ...
                    typedObj["data"]["output-data"]["kind"] === "not-enrolled" ||
                    typedObj["data"]["output-data"]["kind"] === "upload-expired" ||
                    typedObj["data"]["output-data"]["kind"] === "unknown-upload") &&
                Array.isArray(typedObj["data"]["output-data"]["trace"]) &&
                typedObj["data"]["output-data"]["trace"].every((e: any) =>
                    typeof e === "string"
                ) ||
                (typedObj["data"] !== null &&
                    typeof typedObj["data"] === "object" ||
                ...
                typedObj["data"]["output-data"]["student_file_paths"].every((e: any) =>
                    typeof e === "string"
                ) &&
                Array.isArray(typedObj["data"]["output-data"]["exercise_file_paths"]) &&
                typedObj["data"]["output-data"]["exercise_file_paths"].every((e: any) =>
                    typeof e === "string"
                ) ||
                (typedObj["data"] !== null &&
                    typeof typedObj["data"] === "object" ||
                ...
                typedObj["data"]["output-data"]["exercises"].every((e: any) =>
                    ...
                    (e["tmcproject-yml"] === null ||
                        ...
                        (e["tmcproject-yml"]["minimum_python_version"]["minor"] === null ||
                            typeof e["tmcproject-yml"]["minimum_python_version"]["minor"] === "number") &&
                        (e["tmcproject-yml"]["minimum_python_version"]["patch"] === null ||
                            typeof e["tmcproject-yml"]["minimum_python_version"]["patch"] === "number") &&
                        typeof e["tmcproject-yml"]["sandbox_image"] === "string" &&
                        typeof e["tmcproject-yml"]["submission_size_limit_mb"] === "number")
                ) ||
                (typedObj["data"] !== null &&
                    typeof typedObj["data"] === "object" ||
                    typeof typedObj["data"] === "function") &&
                ...
                typedObj["data"]["output-data"]["tests"].every((e: any) =>
                    (e !== null &&
                        typeof e === "object" ||
                        typeof e === "function") &&
                    typeof e["name"] === "string" &&
                ...
                Array.isArray(typedObj["data"]["output-data"]["not_attempted"]) &&
                typedObj["data"]["output-data"]["not_attempted"].every((e: any) =>
                    (e !== null &&
                        typeof e === "object" ||
                        typeof e === "function") &&
                    typeof e["exercise-id"] === "string" &&
                ...
                typeof typedObj["data"]["output-data"]["stopped_for_auth"] === "boolean" ||
                (typedObj["data"] !== null &&
                    typeof typedObj["data"] === "object" ||
                    typeof typedObj["data"] === "function") &&
                ...
                typedObj["data"]["output-data"]["details"]["exercises"].every((e: any) =>
                    (e !== null &&
                        typeof e === "object" ||
                        typeof e === "function") &&
                    typeof e["id"] === "number" &&
                    ...
                    (e["soft_deadline"] === null ||
                        typeof e["soft_deadline"] === "string") &&
                    ...
                    (e["memory_limit"] === null ||
                        typeof e["memory_limit"] === "number") &&
                    Array.isArray(e["runtime_params"]) &&
                    e["runtime_params"].every((e: any) =>
                        typeof e === "string"
                    ) &&
                    (e["valgrind_strategy"] === null ||
                        typeof e["valgrind_strategy"] === "string") &&
                ...
                typedObj["data"]["output-data"]["exercises"].every((e: any) =>
                    ...
                    e["available_points"].every((e: any) =>
                        (e !== null &&
                            typeof e === "object" ||
                            typeof e === "function") &&
                        typeof e["id"] === "number" &&
                    ...
                    e["awarded_points"].every((e: any) =>
                        typeof e === "string"
                    ) &&
                    typeof e["name"] === "string" &&
                    (e["publish_time"] === null ||
                        typeof e["publish_time"] === "string") &&
                ...
                (typedObj["data"]["output-data"]["settings"]["hidden_if_registered_after"] === null ||
                    typeof typedObj["data"]["output-data"]["settings"]["hidden_if_registered_after"] === "string") &&
                (typedObj["data"]["output-data"]["settings"]["refreshed_at"] === null ||
                    typeof typedObj["data"]["output-data"]["settings"]["refreshed_at"] === "string") &&
                typeof typedObj["data"]["output-data"]["settings"]["locked_exercise_points_visible"] === "boolean" &&
                ...
                (typedObj["data"]["output-data"]["settings"]["certificate_unlock_spec"] === null ||
                    typeof typedObj["data"]["output-data"]["settings"]["certificate_unlock_spec"] === "string") &&
                ...
                (typedObj["data"]["output-data"]["settings"]["course_template_id"] === null ||
                    typeof typedObj["data"]["output-data"]["settings"]["course_template_id"] === "number") &&
                typeof typedObj["data"]["output-data"]["settings"]["hide_submission_results"] === "boolean" &&
                (typedObj["data"]["output-data"]["settings"]["external_scoreboard_url"] === null ||
                    typeof typedObj["data"]["output-data"]["settings"]["external_scoreboard_url"] === "string") &&
                (typedObj["data"]["output-data"]["settings"]["organization_slug"] === null ||
                    typeof typedObj["data"]["output-data"]["settings"]["organization_slug"] === "string") ||
                (typedObj["data"] !== null &&
                    typeof typedObj["data"] === "object" ||
                    typeof typedObj["data"] === "function") &&
                ...
                typeof typedObj["data"]["output-data"]["run_tests_locally_action_enabled"] === "boolean" &&
                ...
                typedObj["data"]["output-data"]["submissions"].every((e: any) =>
                    (e !== null &&
                        typeof e === "object" ||
                        typeof e === "function") &&
                    ...
                    (e["paste_url"] === null ||
                        typeof e["paste_url"] === "string") &&
                    (e["processing_time"] === null ||
                        typeof e["processing_time"] === "number") &&
                    typeof e["reviewed"] === "boolean" &&
                ...
                typedObj["data"]["output-data"].every((e: any) =>
                    ...
                    typeof e["id"] === "number" &&
                    typeof e["user_id"] === "number" &&
                    (e["pretest_error"] === null ||
                        typeof e["pretest_error"] === "string") &&
                    typeof e["created_at"] === "string" &&
                    typeof e["exercise_name"] === "string" &&
                    typeof e["course_id"] === "number" &&
                    ...
                    (e["points"] === null ||
                        typeof e["points"] === "string") &&
                    (e["processing_tried_at"] === null ||
                        typeof e["processing_tried_at"] === "string") &&
                    (e["processing_began_at"] === null ||
                        typeof e["processing_began_at"] === "string") &&
                ...
                typedObj["data"]["output-data"]["created"].every((e: any) =>
                    (e !== null &&
                        typeof e === "object" ||
                        typeof e === "function") &&
                    typeof e["id"] === "number" &&
                ...
                typedObj["data"]["output-data"]["updated"].every((e: any) =>
                    (e !== null &&
                        typeof e === "object" ||
                        typeof e === "function") &&
                    typeof e["id"] === "number" &&
                ...
                typedObj["data"]["output-data"].every((e: any) =>
                    ...
                    e["points_not_awarded"].every((e: any) =>
                        typeof e === "string"
                    ) &&
                    typeof e["url"] === "string" &&
                ...
                typedObj["data"]["output-data"]["points"].every((e: any) =>
                    typeof e === "string"
                ) &&
                ...
                typedObj["data"]["output-data"]["missing_review_points"].every((e: any) =>
                    typeof e === "string"
                ) &&
                (typedObj["data"]["output-data"]["test_cases"] === null ||
                    Array.isArray(typedObj["data"]["output-data"]["test_cases"]) &&
                    typedObj["data"]["output-data"]["test_cases"].every((e: any) =>
                        (e !== null &&
                            typeof e === "object" ||
                            typeof e === "function") &&
                        typeof e["name"] === "string" &&
                        ...
                        (e["exception"] === null ||
                            ...
                            e["exception"].every((e: any) =>
                                typeof e === "string"
                            )) &&
                        (e["detailed_message"] === null ||
                            typeof e["detailed_message"] === "string")
                    )) &&
                (typedObj["data"]["output-data"]["feedback_questions"] === null ||
                    Array.isArray(typedObj["data"]["output-data"]["feedback_questions"]) &&
                    typedObj["data"]["output-data"]["feedback_questions"].every((e: any) =>
                        (e !== null &&
                            typeof e === "object" ||
                            typeof e === "function") &&
                        typeof e["id"] === "number" &&
                ...
                (typedObj["data"]["output-data"]["validations"] === null ||
                    ...
                    (typedObj["data"]["output-data"]["validations"]["validationErrors"] === null ||
                        (typedObj["data"]["output-data"]["validations"]["validationErrors"] !== null &&
                            typeof typedObj["data"]["output-data"]["validations"]["validationErrors"] === "object" ||
                            typeof typedObj["data"]["output-data"]["validations"]["validationErrors"] === "function") &&
                        Object.entries<any>(typedObj["data"]["output-data"]["validations"]["validationErrors"])
                            .every(([key, value]) => (Array.isArray(value) &&
                                value.every((e: any) =>
                                    (e !== null &&
                                        typeof e === "object" ||
                ...
                (typedObj["data"] !== null &&
                    typeof typedObj["data"] === "object" ||
                    typeof typedObj["data"] === "function") &&
                typedObj["data"]["output-data-kind"] === "mooc-updated-exercises" &&
                Array.isArray(typedObj["data"]["output-data"]) &&
                typedObj["data"]["output-data"].every((e: any) =>
                    typeof e === "string"
                ) ||
                ...
                (typedObj["data"] !== null &&
                    typeof typedObj["data"] === "object" ||
                    typeof typedObj["data"] === "function") &&
                typedObj["data"]["output-data-kind"] === "mooc-course" &&
                (typedObj["data"]["output-data"] !== null &&
                    typeof typedObj["data"]["output-data"] === "object" ||
                    typeof typedObj["data"]["output-data"] === "function") &&
                typeof typedObj["data"]["output-data"]["id"] === "string" &&
                typeof typedObj["data"]["output-data"]["slug"] === "string" &&
                typeof typedObj["data"]["output-data"]["name"] === "string" &&
                (typedObj["data"]["output-data"]["description"] === null ||
                    typeof typedObj["data"]["output-data"]["description"] === "string") &&
                typeof typedObj["data"]["output-data"]["organization_name"] === "string" ||
                (typedObj["data"] !== null &&
                    typeof typedObj["data"] === "object" ||
                    typeof typedObj["data"] === "function") &&
                typedObj["data"]["output-data-kind"] === "mooc-courses" &&
                Array.isArray(typedObj["data"]["output-data"]) &&
                typedObj["data"]["output-data"].every((e: any) =>
                    (e !== null &&
                        typeof e === "object" ||
                    ...
                    (e["description"] === null ||
                        typeof e["description"] === "string") &&
                    typeof e["organization_name"] === "string"
                ) ||
                (typedObj["data"] !== null &&
                    typeof typedObj["data"] === "object" ||
                    typeof typedObj["data"] === "function") &&
                ...
                typedObj["data"]["output-data"].every((e: any) =>
                    ...
                    e["tasks"].every((e: any) =>
                        ...
                        (e["public_spec"] === null ||
                            ...
                            typeof e["public_spec"]["stub_download_url"] === "string" &&
                            Array.isArray(e["public_spec"]["student_file_paths"]) &&
                            e["public_spec"]["student_file_paths"].every((e: any) =>
                                typeof e === "string"
                            ) &&
                            typeof e["public_spec"]["checksum"] === "string" &&
                            (e["public_spec"]["browser_test"] === null ||
                                (e["public_spec"]["browser_test"] !== null &&
                                    typeof e["public_spec"]["browser_test"] === "object" ||
                                    typeof e["public_spec"]["browser_test"] === "function") &&
                                e["public_spec"]["browser_test"]["runtime"] === "python" &&
                                typeof e["public_spec"]["browser_test"]["script"] === "string" &&
                                (e["public_spec"]["browser_test"]["error"] === null ||
                                    typeof e["public_spec"]["browser_test"]["error"] === "string"))) &&
                        (e["model_solution_spec"] === null ||
                            ...
                            typeof e["model_solution_spec"]["solution_download_url"] === "string") &&
                        (e["checksum"] === null ||
                            typeof e["checksum"] === "string")
                    )
                ) ||
                ...
                typeof typedObj["data"]["output-data"]["course_id"] === "string" &&
                typeof typedObj["data"]["output-data"]["exercise_name"] === "string" &&
                ...
                (typedObj["data"]["output-data"] !== null &&
                    typeof typedObj["data"]["output-data"] === "object" ||
                    typeof typedObj["data"]["output-data"] === "function") &&
                typeof typedObj["data"]["output-data"]["task_submission_id"] === "string" &&
                typeof typedObj["data"]["output-data"]["slide_submission_id"] === "string" ||
                (typedObj["data"] !== null &&
                    typeof typedObj["data"] === "object" ||
                    typeof typedObj["data"] === "function") &&
                typedObj["data"]["output-data-kind"] === "mooc-submission-status" &&
                (typedObj["data"]["output-data"] === "NoGradingYet" ||
                    (typedObj["data"]["output-data"] !== null &&
                        typeof typedObj["data"]["output-data"] === "object" ||
                        typeof typedObj["data"]["output-data"] === "function") &&
                    (typedObj["data"]["output-data"]["Grading"] !== null &&
                        typeof typedObj["data"]["output-data"]["Grading"] === "object" ||
                        typeof typedObj["data"]["output-data"]["Grading"] === "function") &&
                    (typedObj["data"]["output-data"]["Grading"]["grading_progress"] === "Failed" ||
                        typedObj["data"]["output-data"]["Grading"]["grading_progress"] === "NotReady" ||
                        typedObj["data"]["output-data"]["Grading"]["grading_progress"] === "PendingManual" ||
                        typedObj["data"]["output-data"]["Grading"]["grading_progress"] === "Pending" ||
                        typedObj["data"]["output-data"]["Grading"]["grading_progress"] === "FullyGraded") &&
                    (typedObj["data"]["output-data"]["Grading"]["score_given"] === null ||
                        typeof typedObj["data"]["output-data"]["Grading"]["score_given"] === "number") &&
                    (typedObj["data"]["output-data"]["Grading"]["grading_started_at"] === null ||
                        typeof typedObj["data"]["output-data"]["Grading"]["grading_started_at"] === "string") &&
                    (typedObj["data"]["output-data"]["Grading"]["grading_completed_at"] === null ||
                        typeof typedObj["data"]["output-data"]["Grading"]["grading_completed_at"] === "string") &&
                    (typedObj["data"]["output-data"]["Grading"]["feedback_text"] === null ||
                        typeof typedObj["data"]["output-data"]["Grading"]["feedback_text"] === "string")) ||
                (typedObj["data"] !== null &&
                    typeof typedObj["data"] === "object" ||
                    typeof typedObj["data"] === "function") &&
                typedObj["data"]["output-data-kind"] === "mooc-submissions" &&
                Array.isArray(typedObj["data"]["output-data"]) &&
                typedObj["data"]["output-data"].every((e: any) =>
                    (e !== null &&
                        typeof e === "object" ||
                    ...
                    typeof e["created_at"] === "string" &&
                    (e["score_given"] === null ||
                        typeof e["score_given"] === "number") &&
                    (e["grading_progress"] === null ||
                        e["grading_progress"] === "Failed" ||
                        e["grading_progress"] === "NotReady" ||
                        e["grading_progress"] === "PendingManual" ||
                        e["grading_progress"] === "Pending" ||
                        e["grading_progress"] === "FullyGraded")
                ) ||
                (typedObj["data"] !== null &&
                    typeof typedObj["data"] === "object" ||
                    typeof typedObj["data"] === "function") &&
                typedObj["data"]["output-data-kind"] === "mooc-paste" &&
                (typedObj["data"]["output-data"] !== null &&
                    typeof typedObj["data"]["output-data"] === "object" ||
                    typeof typedObj["data"]["output-data"] === "function") &&
                typeof typedObj["data"]["output-data"]["paste_url"] === "string" ||
                (typedObj["data"] !== null &&
                    typeof typedObj["data"] === "object" ||
                    typeof typedObj["data"] === "function") &&
                typedObj["data"]["output-data-kind"] === "mooc-course-progress" &&
                (typedObj["data"]["output-data"] !== null &&
                    typeof typedObj["data"]["output-data"] === "object" ||
                    typeof typedObj["data"]["output-data"] === "function") &&
                typeof typedObj["data"]["output-data"]["course_id"] === "string" &&
                ...
                (typedObj["data"] !== null &&
                    typeof typedObj["data"] === "object" ||
                    typeof typedObj["data"] === "function") &&
                typedObj["data"]["output-data-kind"] === "mooc-old-submission-restore" &&
                (typedObj["data"]["output-data"] === "restored" ||
                    typedObj["data"]["output-data"] === "nothing-to-download")) ||
            (typedObj !== null &&
                typeof typedObj === "object" ||
                typeof typedObj === "function") &&
            ...
            (typedObj !== null &&
                typeof typedObj === "object" ||
                typeof typedObj === "function") &&
            typedObj["update-data-kind"] === "mooc-client-update-data" &&
            (typedObj !== null &&
                typeof typedObj === "object" ||
                typeof typedObj === "function") &&
            typeof typedObj["finished"] === "boolean" &&
            ...
            (typedObj["data"] === null ||
                (typedObj["data"] !== null &&
                    ...
                    typeof typedObj["data"] === "function") &&
                typedObj["data"]["client-update-data-kind"] === "exercise-download" &&
                typeof typedObj["data"]["id"] === "string" &&
                typeof typedObj["data"]["path"] === "string") ||
            (typedObj !== null &&
                typeof typedObj === "object" ||
                typeof typedObj === "function") &&
            ...
            (typedObj !== null &&
                typeof typedObj === "object" ||
                typeof typedObj === "function") &&
            typedObj["update-data-kind"] === "mooc-device-login" &&
            (typedObj !== null &&
                typeof typedObj === "object" ||
                typeof typedObj === "function") &&
            typeof typedObj["finished"] === "boolean" &&
            ...
            (typedObj["data"] === null ||
                (typedObj["data"] !== null &&
                    typeof typedObj["data"] === "object" ||
                    typeof typedObj["data"] === "function") &&
                typeof typedObj["data"]["verification_uri"] === "string" &&
                (typedObj["data"]["verification_uri_complete"] === null ||
                    typeof typedObj["data"]["verification_uri_complete"] === "string") &&
                typeof typedObj["data"]["user_code"] === "string" &&
                typeof typedObj["data"]["expires_in"] === "number" &&
            ...
            (typedObj !== null &&
                typeof typedObj === "object" ||
                typeof typedObj === "function") &&
            (typedObj["notification-kind"] === "warning" ||
                typedObj["notification-kind"] === "info") &&
            typeof typedObj["message"] === "string")
    )
}
...
export function isRunResult(obj: unknown): obj is RunResult {
    ...
    return (
        ...
        typedObj["testResults"].every((e: any) =>
            (e !== null &&
                typeof e === "object" ||
                typeof e === "function") &&
            typeof e["name"] === "string" &&
        ...
        (typedObj["logs"] !== null &&
            typeof typedObj["logs"] === "object" ||
            typeof typedObj["logs"] === "function") &&
        Object.entries<any>(typedObj["logs"])
