...
export function isToolCallFields(obj: unknown): obj is ToolCallFields {
    const typedObj = obj as ToolCallFields
    return (
        (typedObj !== null &&
            typeof typedObj === "object" ||
            typeof typedObj === "function") &&
        ...
        typeof typedObj["tool_arguments"] === "string" &&
        typeof typedObj["tool_call_id"] === "string"
    )
}

export function isToolOutput(obj: unknown): obj is ToolOutput {
    const typedObj = obj as ToolOutput
    return (
        (typedObj !== null &&
            typeof typedObj === "object" ||
            typeof typedObj === "function") &&
