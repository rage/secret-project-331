...
export function isPageUpdatePreview(obj: unknown): obj is PageUpdatePreview {
    const typedObj = obj as PageUpdatePreview
    return (
        (typedObj !== null &&
            typeof typedObj === "object" ||
            typeof typedObj === "function") &&
        Array.isArray(typedObj["exercises_to_be_deleted"]) &&
        typedObj["exercises_to_be_deleted"].every((e: any) =>
            isCmsPageExercise(e) as boolean
        )
    )
}
