...
export function isChatbotConversationMessage(obj: unknown): obj is ChatbotConversationMessage {
    ...
    return (
        ...
        (typedObj["tool_output_id"] === null ||
            typeof typedObj["tool_output_id"] === "string") &&
        (typedObj["tool_call_fields_id"] === null ||
            typeof typedObj["tool_call_fields_id"] === "string")
    )
}
