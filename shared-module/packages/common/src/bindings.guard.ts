...
export function isUserChapterLock(obj: unknown): obj is UserChapterLock {
    const typedObj = obj as UserChapterLock
    return (
        (typedObj !== null &&
            typeof typedObj === "object" ||
            typeof typedObj === "function") &&
