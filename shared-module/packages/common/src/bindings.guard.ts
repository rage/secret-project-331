...
export function isCourseDesignerPlanDetails(obj: unknown): obj is CourseDesignerPlanDetails {
    ...
    return (
        ...
        typedObj["stages"].every((e: any) =>
            isCourseDesignerPlanStage(e) as boolean
        )
    )
}
