...
export function HybridTimeSelector({
  ...
  return (
    // oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- styled panel div; a semantic grouping element would change default styling
    <div className={timePanelCss} role="group" aria-labelledby={groupId}>
      ...
      <div className={timeControlsRowCss}>
        ...
        {showsDayPeriod ? (
          // oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- styled toggle div; a semantic grouping element would change default styling
