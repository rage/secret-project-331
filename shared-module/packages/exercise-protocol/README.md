...
and runs the complete browser suite. CI runs Chromium and Firefox for pull requests; the full
contract job also runs WebKit. Failed tests retain traces, full-page screenshots, and video.
