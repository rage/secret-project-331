...
export function isRequestRepositoryExercisesMessage(
  obj: unknown,
): obj is RequestRepositoryExercisesMessage {
...
export function isOpenDialogMessage(obj: unknown): obj is OpenDialogMessage {
  ...
  return (
    ...
    (typedObj["dialogType"] === "confirm" || typedObj["dialogType"] === "warning") &&
    typeof typedObj["title"] === "string" &&
    Array.isArray(typedObj["body"]) &&
    typedObj["body"].every((e: any) => typeof e === "string") &&
