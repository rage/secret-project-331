...
async function createLoginStates(page: Page, context: BrowserContext) {
  const usersLoginInformationToCache = [
    ...
    { email: "student6@example.com", password: "student6" },
    { email: "student7@example.com", password: "student7" },
    { email: "student8@example.com", password: "student8" },
    { email: "student9@example.com", password: "student9" },
    { email: "student10@example.com", password: "student10" },
    { email: "student11@example.com", password: "student11" },
    { email: "student12@example.com", password: "student12" },
    { email: "student13@example.com", password: "student13" },
    { email: "student14@example.com", password: "student14" },
    { email: "student15@example.com", password: "student15" },
    { email: "student16@example.com", password: "student16" },
