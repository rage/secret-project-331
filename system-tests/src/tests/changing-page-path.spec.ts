...
test('test', async ({ page }) => {
  ...
  await page.getByRole('row', { name: 'page with wrong path /chapter-1/page-with-wrong-path Edit page Dropdown menu' }).getByLabel('Dropdown menu').click();
  ...
  await page.goto(`http://project-331.local/org/uh-mathstat/courses/change-path/chapter-1/page-with-wrong-path`)
  await page.waitForURL(`http://project-331.local/org/uh-mathstat/courses/change-path/chapter-1/page-with-right-path-yeah`)
});
