...
test("Mark answer as spam in peer review", async ({}) => {
  ...
  // Admin changes courses flagged answers threshold
  ...
  //Student2 answers an exercise, starts peer review and reports answer
  ...
  //Admin checks that the reported answer that has exceeded the reporting threshold is in the answers requiring atention
  await teacherPage.goto(
    "http://project-331.local/manage/courses/c47e1cfd-a2da-4fd1-aca8-f2b2d906c4c0",
  )
