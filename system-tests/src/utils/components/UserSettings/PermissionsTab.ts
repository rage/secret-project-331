...
export class PermissionsTab {
  ...
  public async updateGeneralResearchConsent(consent: boolean, verifyUpdate = true): Promise<void> {
  ...
  public async getGeneralResearchConsentValue(): Promise<string | null> {
    return await this.page.getByTestId("general-research-consent-value").textContent()
  }

  public async getCourseSpecificConsents(): Promise<
    { courseName: string; courseId: string; editLink: Locator | null }[]
  > {
    ...
    const consents: { courseName: string; courseId: string; editLink: Locator | null }[] = []
  ...
  public async editCourseSpecificConsent(courseName: string): Promise<void> {
  ...
  public async scrollToAuthorizedApplications(): Promise<void> {
  ...
  public async getAuthorizedApplications(): Promise<
    { name: string; scopes: string; clientId: string; revokeButton: Locator }[]
  > {
  ...
  public async revokeAuthorizedApplication(appName: string): Promise<void> {
  ...
  public async confirmAccountDeletionWithPassword(password: string): Promise<void> {
